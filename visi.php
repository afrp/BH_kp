...
<head>
    ...
    <title>Visi dan Misi | Pesantren Baitul Hikmah</title>
...
<?php include 'kontrol/database.php' ?>
    ...
    <section id="terms" class="container">
        <?php 
            $baca=mysql_query("select * from tb_profil where id_pro='2'");
            $tulis=mysql_fetch_array($baca);
         ?>
        <h3><?php echo $tulis['judul_pro']; ?></h3>
        <pre><?php echo $tulis['isi_pro']; ?></pre>

        <p>&nbsp;</p>
        <?php 
            $bac=mysql_query("select * from tb_profil where id_pro='3'");
            $tuli=mysql_fetch_array($bac);
         ?>
        <h3><?php echo $tuli['judul_pro']; ?></h3>
        <pre><?php echo $tuli['isi_pro']; ?></pre>
