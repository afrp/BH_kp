            ...
            <div id="page-inner">
                ...
                <div class="alert  alert-info">
                    ...
                    <hr />
                        ...
                        <a href="input_galeri.php" class="btn btn-success btn-lg" id="tambah"><i class="fa fa-plus-circle"></i> Tambah Galeri</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select * from tb_galeri where id_poto LIKE '%$input_cari%' or judul_poto LIKE '%$input_cari%' or jls_poto LIKE '%$input_cari%' or poto LIKE '%$input_cari%' ") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select * from tb_galeri") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select * from tb_galeri") or die (mysql_error());
                                        }
                                    ...
                                    ?>
                                        <tr>                                            
                                            <td><?php echo $baris['id_poto']; ?></td>
                                            <td><?php echo $baris['judul_poto']; ?></td>
                                            <td><?php echo $baris['jls_poto']; ?></td>                                            
                                            <td><a href="gmb/galeri/<?php echo $baris['poto'] ?>" target="_blank">Lihat Foto</a></td>
                                            <td><a href="edit_galeri.php?id=<?php echo $baris['id_poto']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                            <a href="#" data-href="hapus_galeri.php?id=<?php echo $baris['id_poto']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
