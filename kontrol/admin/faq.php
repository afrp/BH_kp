                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select * from tb_tanya where id_tanya LIKE '%$input_cari%' or judul_tanya LIKE '%$input_cari%' or nama_tanya LIKE '%$input_cari%' or email_tanya LIKE '%$input_cari%' or isi_tanya LIKE '%$input_cari%'") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select * from tb_tanya") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select * from tb_tanya") or die (mysql_error());
                                        }
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $baris['id_tanya']; ?></td>
                                            <td><?php echo $baris['judul_tanya']; ?></td>
                                            <td><?php echo $baris['nama_tanya']; ?></td>
                                            <td><?php echo $baris['email_tanya']; ?></td>
                                            <td><?php echo $baris['isi_tanya']; ?></td>
                                            <td><?php echo $baris['jawab_tanya']; ?></td>                                            
                                            <td><a href="edit_tanya.php?id=<?php echo $baris['id_tanya']; ?>" class="btn btn-primary btn-xs">Edit</a> |
                                            <a href="" data-href="hapus_tanya.php?id=<?php echo $baris['id_tanya']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
