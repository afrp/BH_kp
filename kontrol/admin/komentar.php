            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a class="active-menu" href="komentar.php"><i class="fa fa-code "></i>Komentar</a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select *from tb_komentar where id_komen LIKE '%$input_cari%' or id_akl LIKE '%$input_cari%'or nama LIKE '%$input_cari%' or email LIKE '%$input_cari%' or komentar LIKE '%$input_cari%' order by waktu_komen desc") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select *from tb_komentar order by waktu_komen desc") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select *from tb_komentar order by waktu_komen desc") or die (mysql_error());
                                        }
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $baris['id_komen']; ?></td>
                                            <td><?php echo $baris['id_akl']; ?></td>
                                            <td><?php echo $baris['nama']; ?></td>
                                            <td><?php echo $baris['email']; ?></td>
                                            <td><?php echo $baris['komentar']; ?></td>
                                            <td><a href="#" data-href="hapus_komen.php?id=<?php echo $baris['id_komen']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
