...
<?php 
    ...
    $cari_kd=mysql_query("select max(id_akl) as kode from tb_artikel");
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Input Artikel</h1>
                    </div>
                </div>
            <div class="row">            
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_artikel.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_art" name="id" value="<?php echo $id; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulArtikel">Judul Artikel</label>
                                        <input type="text" class="form-control" id="judul_art" name="judul" placeholder="Judul Artikel" />
                                      </div>
                                      <div class="form-group">
                                        <label for="isiArtikel">Isi Artikel</label>
                                        <textarea class="form-control" rows="3" id="isi_art" name="isi" placeholder="Isi Artikel"></textarea>
                                      </div>
                                      <div class="form-group">
                                        <label for="penulisArtikel">Pengirim Artikel</label>
                                        <input type="text" class="form-control" id="tulis_art" name="pengirim" placeholder="Pengirim Artikel" />
                                      </div>                                      
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Photo Penulis</label>
                                        <input type="file" id="poto_art" name="poto" />
                                        <!--<p class="help-block">Example block-level help text here.</p>-->
                                      </div>
                                      <div class="form-group">
                                        <label for="isiArtikel">Keterangan Penulis</label>
                                        <textarea class="form-control" rows="3" id="ket_art" name="ket" placeholder="Keterangan Penulis"></textarea>
                                      </div>
                                      <div class="checkbox">
                                        <label>
