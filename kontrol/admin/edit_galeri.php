...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Edit Data Foto Galeri</h1>
                    </div>
                </div>
                <?php 
    
    $id=$_GET['id'];
    $cari_kd=mysql_query("select * from tb_galeri where id_poto='$id'");
 ...
 ?>
            ...
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_edit_galeri.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_karya" name="id" value="<?php echo $pecah['id_poto']; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulFoto">Nama Foto</label>
                                        <input type="text" class="form-control" id="judul_Foto" name="nama" placeholder="Nama Foto" value="<?php echo $pecah['judul_poto']; ?>"/>
                                      </div>
                                      <div class="form-group">
                                        <label for="isiBerita">Makna Foto</label>
                                        <textarea class="form-control" rows="3" id="jelas_Foto" name="isi" placeholder="Isi Kegiatan"><?php echo $pecah['jls_poto']; ?></textarea>
                                      </div>                                          
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Foto Baru</label><br/>
                                        <img src="gmb/galeri/<?php echo $pecah['poto']; ?>" alt="" width="200" height="150" /><br/><br/>
