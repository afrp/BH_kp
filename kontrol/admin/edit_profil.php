...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Edit Profil</h1>
                    </div>
                </div>
                <?php 
    
    $id=$_GET['id'];
    $cari_kd=mysql_query("select * from tb_profil where id_pro='$id'");
 ...
 ?>
            ...
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_edit_profil.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_pro" name="id" value="<?php echo $pecah['id_pro']; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulFoto">Judul Profil</label>
                                        <input type="text" class="form-control" id="judul_Pro" name="nama" placeholder="Judul Profil" value="<?php echo $pecah['judul_pro']; ?>"/>
                                      </div>
                                      <div class="form-group">
                                        <label for="isiBerita">Isi Profil</label>
                                        <textarea class="form-control" rows="3" id="isi_profil" name="isi" placeholder="Isi Profil"><?php echo $pecah['isi_pro']; ?></textarea>
                                      </div>                                          
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Foto Profil</label><br/>
                                        <img src="gmb/profil/<?php echo $pecah['gbr_pro']; ?>" alt="" width="200" height="150" /><br/><br/>
