...
<?php 
    ...
    $cari_kd=mysql_query("select max(id_kgt) as kode from tb_kegiatan");
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Input Kegiatan</h1>
                    </div>
                </div>
            <div class="row">            
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_kgt.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_bta" name="id" value="<?php echo $id; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulKgt">Nama Kegiatan</label>
                                        <input type="text" class="form-control" id="nama_kgt" name="nama" placeholder="Nama Kegiatan" />
                                      </div>
                                      <div class="form-group">
                                        <label for="isiKgt">Isi Kegiatan</label>
                                        <textarea class="form-control" rows="3" id="isi_kgt" name="isinya" placeholder="Isi Kegiatan"></textarea>
                                      </div>                                          
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Gambar Kegiatan</label>
