...
<?php 
    ...
    $cari_kd=mysql_query("select max(id_bta) as kode from tb_berita");
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            ...
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_berita.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_bta" name="id" value="<?php echo $id; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulBerita">Judul Berita</label>
                                        <input type="text" class="form-control" id="judul_bta" name="judul" placeholder="Judul Berita" />
                                      </div>
                                      <div class="form-group">
                                        <label for="HeadlineBerita">HeadLine Berita</label>
                                        <input type="text" class="form-control" id="judul_bta" name="hed" placeholder="Headline Berita" />
                                      </div>
                                      <div class="form-group">
                                        <label for="isiBerita">Isi Berita</label>
                                        <textarea class="form-control" rows="3" id="isi_bta" name="isi" placeholder="Isi Berita"></textarea>
                                      </div>
                                      <div class="form-group">
                                        <label for="penulisBerita">Pengirim Berita</label>
                                        <input type="text" class="form-control" id="tulis_bta" name="pengirim" placeholder="Pengirim Berita" />
                                      </div>                                      
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Gambar Berita</label>
