            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                     ...
                     <li>
                        <a  href="#"> <strong> Ade Fathur</strong></a>
                    </li>
            ...
            <div id="page-inner">
                ...
                <div class="alert  alert-info">
                    <div class="current-notices">
                            ...
                            <h4>Pencarian</h4>
                    <hr />
                            <input type="text" class="form-control" id="cariArtikel" placeholder="Masukan Kata" />
                        ...
                        <a href="#" class="btn btn-success btn-lg" id="tambah"><i class="fa fa-plus-circle"></i> Tambah Artikel</a>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
