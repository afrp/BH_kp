            ...
            <div id="page-inner">
                ...
                <div class="alert  alert-info">
                    ...
                    <hr />
                        ...
                        <a href="input_berita.php" class="btn btn-success btn-lg" id="tambah"><i class="fa fa-plus-circle"></i> Tambah Berita</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                   ...
                                   <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select * from tb_berita where id_bta LIKE '%$input_cari%' or judul_bta LIKE '%$input_cari%' or isi_bta LIKE '%$input_cari%' or pengirim LIKE '%$input_cari%' order by tgl_bta DESC") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select * from tb_berita  order by tgl_bta DESC") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select * from tb_berita  order by tgl_bta DESC") or die (mysql_error());
                                        }
                                    ...
                                    <?php
                                      ...
                                      while ($row = mysql_fetch_array($sql)) { ?>
                                        <tr>
                                            <td><?php echo $row['id_bta']; ?></td>
                                            <td><?php echo $row['tgl_bta']; ?></td>
                                            <td><?php echo $row['judul_bta']; ?></td>
                                            <td><?php echo $row['head_bta']; ?></td>
                                            <td><?php echo $row['isi_bta']; ?></td>
                                            <td><a href="gmb/berita/<?php echo $row['gambar_bta'] ?>" target="_blank">Lihat Foto</a></td>
                                            <td><?php echo $row['pengirim']; ?></td>
                                            <td><a href="edit_berita.php?id=<?php echo $row['id_bta']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                            <a href="#" data-href="hapus_berita.php?id=<?php echo $row['id_bta']; ?>" class="btn btn-danger btn-xs" 
                                            data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
