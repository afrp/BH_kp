...
<head>
  ...
  <title>Pengasuh | Pesantren Baitul Hikmah</title>
...
<?php include 'kontrol/database.php' ?>
  ...
  <section id="title" class="emerald">
    ...
    <?php
    $baca=mysql_query("select * from tb_profil where id_pro='1'");
  ...
  <section id="career" class="container">
    ...
    <hr>
    <div class="center">
      <img src="kontrol/admin/gmb/profil/<?php echo $tulis['gbr_pro']; ?>" class="img-responsive img-thumbnail" height="240" width="180">
      </div>
    <hr>
    <div class="col-md-12">
