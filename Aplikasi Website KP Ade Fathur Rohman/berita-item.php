...
<head>
    ...
    <title>Berita Rinci | Pesantren Baitul Hikmah</title>
    ...
    <section id="blog" class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    <?php  
                            $result= mysql_query("select * from tb_berita where id_bta='". $_GET['id'] ."'");
                            while ($masuk=mysql_fetch_array($result)) {
                    ?>
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="kontrol/admin/gmb/berita/<?php echo $masuk['gambar_bta'];?>" width="100%" alt="" />
                        <div class="blog-content">
                            <h2><?php echo $masuk['judul_bta']; ?></h2>
                            <div class="entry-meta">
                                <span><i class="icon-user"></i> <a href="#"><?php echo $masuk['pengirim']; ?></a></span>
                                <span><i class="icon-calendar"></i> <?php echo $masuk['tgl_bta']; ?></span>                                
                            </div>
                            <h4><?php echo $masuk['head_bta']; ?></h4>

                            <p><?php echo $masuk['isi_bta']; ?></p>                           
                            ...
                            <div id="comments-list">
                                ...
                                <div id="comment-form">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" action="kontrol/submit_komen2.php">
