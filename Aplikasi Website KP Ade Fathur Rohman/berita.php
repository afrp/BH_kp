...
<head>
    ...
    <title>Berita | Pesantren Baitul Hikmah</title>
    ...
    <section id="blog" class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                <?php 
                $sql = mysql_query("SELECT * FROM tb_berita order by tgl_bta DESC limit $posisi, $batas");
                $no = 1+$posisi;
                while ( $data = mysql_fetch_assoc( $sql ) ) {
    
                 ?>
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="kontrol/admin/gmb/berita/<?php echo $data['gambar_bta'];?>" width="100%" alt="" />
                        <div class="blog-content">
                            <a href="#"><h3><?php echo $data['judul_bta']; ?></h3></a>
                            <div class="entry-meta">
                                <span><i class="icon-user"></i> <a href="#"><?php echo $data['pengirim']; ?></a></span>
                                
                                <span><i class="icon-calendar"></i> <?php echo $data['tgl_bta']; ?></span>
                                
                            </div>
                            <p><?php echo readmore(rapikan($data['isi_bta']));?></p>
                            <a class="btn btn-default" href="berita-item.php?id=<?php echo $data['id_bta'] ?>">Read More <i class="icon-angle-right"></i></a>
                        </div>
                    </div><!--/.blog-item-->
                    <?php 
                    $no++;
