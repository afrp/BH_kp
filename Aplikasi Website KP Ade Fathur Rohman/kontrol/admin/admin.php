            ...
            <div id="page-inner">
                ...
                <div class="alert  alert-info">
                    ...
                    <hr />
                        ...
                        <a href="input_admin.php" class="btn btn-success btn-lg" id="tambah"><i class="fa fa-plus-circle"></i> Tambah Admin</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select * from tb_adm where user_adm LIKE '%$input_cari%' or nama_adm LIKE '%$input_cari%' or level_adm LIKE '%$input_cari%'") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select * from tb_adm") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select * from tb_adm") or die (mysql_error());
                                        }
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $baris['user_adm']; ?></td>
                                            <td><?php echo $baris['pass_adm']; ?></td>
                                            <td><?php echo $baris['nama_adm']; ?></td>
                                            <td><?php echo $baris['level_adm']; ?></td>
                                            <td><a href="gmb/admin/<?php echo $baris['gambar_adm'] ?>" target="_blank"> Lihat Gambar </a></td>
                                            <td><a href="edit_admin.php?id=<?php echo $baris['user_adm']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                            <a href="#" data-href="hapus_admin.php?id=<?php echo $baris['user_adm']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
