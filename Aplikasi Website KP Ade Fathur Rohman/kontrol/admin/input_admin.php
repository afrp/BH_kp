...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Input Administator</h1>
                    </div>
                </div>
            <div class="row">            
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_admin.php">
                                      <div class="form-group">
                                        <label for="inputID">User Name</label>
                                        <input type="text" class="form-control" id="user_admin" name="usernya" placeholder="Masukan Username" />
                                      </div>
                                      <div class="form-group">
                                        <label for="password">Password</label>
                                        <input type="text" class="form-control" id="pass_admin" name="passnya" placeholder="Masukan Password" />
                                      </div>                                      
                                      <div class="form-group">
                                        <label for="namaAdmin">Nama</label>
                                        <input type="text" class="form-control" id="nama_admin" name="namanya" placeholder="Masukkan Nama" />
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Photo admin</label>
                                        <input type="file" id="poto_art" name="potonya" />
