...
<?php 
        $cari_kd=mysql_query("select max(id_karya) as kode from tb_karya");
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Input Karya</h1>
                    </div>
                </div>
            <div class="row">            
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_karya.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_karya" name="id" value="<?php echo $id; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulBerita">Judul Karya</label>
                                        <input type="text" class="form-control" id="nama_karya" name="nama" placeholder="Judul Karya" />
                                      </div>
                                      <div class="form-group">
                                        <label for="isiBerita">Penjelasan Karya</label>
                                        <textarea class="form-control" rows="3" id="isi_karya" name="isi" placeholder="Penjelasan Karya"></textarea>
                                      </div>                                          
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Gambar Karya</label>
