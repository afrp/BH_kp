            ...
            <div id="page-inner">
                ...
                <div class="alert  alert-info">
                    ...
                    <hr />
                        ...
                        <a href="input_kgt.php" class="btn btn-success btn-lg" id="tambah"><i class="fa fa-plus-circle"></i> Tambah Kegiatan</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                        ...
                                        if($cari) {
                                        if($input_cari != "") {
                                        $sql = mysql_query("select *from tb_kegiatan where id_kgt LIKE '%$input_cari%' or nama_kgt LIKE '%$input_cari%' or isi_kgt LIKE '%$input_cari%'") or die (mysql_error());   
                                        } else {
                                        $sql = mysql_query("select *from tb_kegiatan") or die (mysql_error());
                                        }
                                        } else {
                                        $sql = mysql_query("select *from tb_kegiatan") or die (mysql_error());
                                        }
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $baris['id_kgt']; ?></td>
                                            <td><?php echo $baris['nama_kgt']; ?></td>
                                            <td><?php echo $baris['isi_kgt']; ?></td>
                                            <td><a href="gmb/keg/<?php echo $baris['gbr_kgt'] ?>" target="_blank">Lihat Foto</a></td>
                                            <td><a href="edit_kgt.php?id=<?php echo $baris['id_kgt']; ?>" class="btn btn-primary btn-xs">Edit</a> | 
                                            <a href="#" data-href="hapus_kgt.php?id=<?php echo $baris['id_kgt']; ?>" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#confirm-delete">Hapus</a></td>
                                        </tr>
                                        <?php
                                    }
                                }
