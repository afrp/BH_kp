...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Edit Karya</h1>
                    </div>
                </div>
                <?php 
    
    $id=$_GET['id'];
    $cari_kd=mysql_query("select * from tb_karya where id_karya='$id'");
 ...
 ?>
            ...
            <div class="col-md-6">
                       ...
                       <form role="form" method="POST" enctype="multipart/form-data" action="submit_edit_karya.php">
                                      <div class="form-group">
                                        <label for="inputID">ID</label>
                                        <input type="text" class="form-control" id="id_karya" name="id" value="<?php echo $pecah['id_karya']; ?>" readonly="readonly" />
                                      </div>
                                      <div class="form-group">
                                        <label for="judulBerita">Judul Karya</label>
                                        <input type="text" class="form-control" id="judul_karya" name="nama" placeholder="Judul Karya" value="<?php echo $pecah['judul_karya']; ?>"/>
                                      </div>
                                      <div class="form-group">
                                        <label for="isiBerita">Isi Kegiatan</label>
                                        <textarea class="form-control" rows="3" id="jelas_karya" name="isi" placeholder="Isi Kegiatan"><?php echo $pecah['jelas_karya']; ?></textarea>
                                      </div>                                          
                                      <div class="form-group">
                                        <label for="exampleInputFile">Input Gambar Kegiatan</label><br/>
                                        <img src="gmb/karya/<?php echo $pecah['gbr_karya']; ?>" alt="" width="200" height="150" /><br/><br/>
