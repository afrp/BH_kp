...
class CnnNav {
    ...
    function CnnNav ($maxRows, $table, $strFieldSelect = "*", $tableId = "", $numShow = "9", $interval = "5", $intervalShow = "3", $prev = "&lsaquo; Prev", $next = "Next &rsaquo;", $separator = " ", $css = "", $first = "&laquo;&laquo;", $last = "&raquo;&raquo;", $strOffset = "offset") {
